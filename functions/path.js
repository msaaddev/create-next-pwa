...
const pwaPath = (name, currentDir) => {
	...
	return {
		...
		tsDocumentFile: `${currentDir}/config/pwa/_document.tsx`,
		winDocumentFile: `${currentDir}${slash}config${slash}pwa${slash}_document.js`,
		winTsDocumentFile: `${currentDir}${slash}config${slash}pwa${slash}_document.tsx`,
...
const tailwindPath = (name, currentDir) => {
	...
	return {
		...
		tsAppjsPath: `${path}/pages/_app.tsx`,
		winAppjsPath: `${path}${slash}pages${slash}_app.js`,
		winTsAppjsPath: `${path}${slash}pages${slash}_app.tsx`,
		...
		tsWriteAppJS: `${currentDir}/config/tailwind/_app.tsx`,
		winWriteAppJS: `${currentDir}${slash}config${slash}tailwind${slash}_app.js`,
		winTsWriteAppJS: `${currentDir}${slash}config${slash}tailwind${slash}_app.tsx`,
